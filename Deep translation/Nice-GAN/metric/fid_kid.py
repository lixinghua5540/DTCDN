...
parser.add_argument('--path', type=str, nargs= 2,default=['E:/code/NICE-GAN-pytorch-master/metric/testA','E:/code/NICE-GAN-pytorch-master/metric/fakeA'],
...
def get_activations(files, model, batch_size=50, dims=2048,
    ...
    for i in tqdm(range(0, len(files), batch_size)):
        ...
        if images.ndim <4:
            images2 = np.zeros((images.shape[0],images.shape[1],images.shape[2],3),dtype=np.float32)
            for i in range(3):
                images2[:,:,:,i] = images
            images = images2
